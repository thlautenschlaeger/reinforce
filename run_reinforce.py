...
def run(args=None):
    ...
    parser.add_argument('--horizon', type=int, default=10000, help='Total rollout horizon')
    ...
    parser.add_argument('--batch_size', type=int, default=64, help='Size of batches for each optimizer step')
